...
| **P6** | [e-ink display](plan/06-phase-eink-display.md) | `/api/display.png` renderer + reTerminal E1001 ESPHome firmware | the kitchen display shows the top "eat me first" items and refreshes unattended |
...
- Hardware isn't needed until **P6** — order the reTerminal E1001 then, not before.
